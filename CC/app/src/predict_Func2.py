...
isExist = os.path.exists('./bert_model/')
...
donwload_model_from_bucket('bert_model/config.json', os.path.join('bert_model/','config.json'),'qwiklabs-gcp-02-96ccf592dc5f-test-bucket')
donwload_model_from_bucket('bert_model/tf_model.h5', os.path.join('bert_model/','tf_model.h5'),'qwiklabs-gcp-02-96ccf592dc5f-test-bucket')
